...
import time
from mmdet3d.models.stocc.utils import CustomDistEvalHook
...
def train_detector(model,
    ...
    gradient_accumulation_cfg = cfg.get('gradient_accumulation', None)
    if gradient_accumulation_cfg is not None:
        optimizer_config = GradientCumulativeFp16OptimizerHook(
            **cfg.optimizer_config, **fp16_cfg, distributed=distributed, **gradient_accumulation_cfg
        )
        print('Using gradient accumulation for', gradient_accumulation_cfg)
